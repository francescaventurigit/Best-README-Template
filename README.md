...
| [**LION.csv**](https://data.bioontology.org/ontologies/LION/download?apikey=8b5b7825-538d-40e0-9e9e-5ab9274a9aeb&download_format=csv)                | CSV file                | Lists all lipids as rows, featuring crucial information such as the lipid's LION code and its parents in the hierarchical structure. |
